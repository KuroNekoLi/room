    ...
    public Dialog onCreateDialog( @Nullable Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("編輯相片", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                ((MainActivity) getActivity()).intentIdToAnotherActivity( ImageEditActivity.class, "image_id", mediaEntityId);
            }
        });
        builder.setNegativeButton("錄音", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                long mediaEntityId = getArguments().getLong(MEDIA_ENTITY_ID_KEY);
                ((MainActivity) getActivity()).intentIdToAnotherActivity( AudioRecordActivity.class,"image_id", mediaEntityId);
            }
        });
